...
const HomePage: React.FC<IHomePage> = () => {
  return (
    <>
      ...
      <section className="mt-[20px] px-4 sm:px-6">
        <TitleSection
        ...
        <div
          className="
        flex flex-col-reverse sm:flex-row gap-4 justify-center sm:items-stretch items-center mt-10"
        >
